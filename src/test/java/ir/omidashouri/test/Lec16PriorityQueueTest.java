...
import ir.omidashouri.test.assignment.Category;
import ir.omidashouri.test.assignment.PriorityQueue;
import ir.omidashouri.test.assignment.UserOrder;
    ...
    public void producer() {
        Flux.interval(Duration.ofSeconds(1))
                ...
                .doOnNext(i -> {
                    ...
                    final Mono<Void> mono = Flux.just(userOrder1, userOrder2, userOrder3, userOrder4, userOrder5)
